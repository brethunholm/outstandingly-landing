...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Outstandingly, San Diego, California.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Outstandingly.io, accessible from
            <a
              href='https://www.outstandingly.io'
              rel='external nofollow noopener noreferrer'
              target='_blank'
            >
              https://www.outstandingly.io
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: legal@outstandingly.io</li>
      </ul>
    </>
  );
}
