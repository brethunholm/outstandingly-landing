...
export default function TosPolicy() {
  return (
    <>
      ...
      <p>
        The Outstandingly.io website located at https://www.outstandingly.io is
        a copyrighted work belonging to Outstandingly. Certain features of the
      ...
      <p>
        ...
        Outstandingly.io uses ‘cookies’. These cookies are used to store
      ...
      <p>
        ...
        the Company should be sent to: San Diego, California. After the Notice
      ...
      <p>Email: legal@outstandingly.io</p>
    </>
  );
}
